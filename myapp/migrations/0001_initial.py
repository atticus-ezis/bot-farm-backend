    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "detection_tags",
                    myapp.fields.FlexibleArrayField(blank=True, default=list),
                ),
            ],
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(
                        fields=["-created_at"], name="myapp_botsub_created_idx"
                    ),
                    models.Index(fields=["ip_address"], name="myapp_botsub_ip_idx"),
                    models.Index(
                        fields=["email_submitted"], name="myapp_botsub_email_idx"
                    ),
                ],
            },
        ),
